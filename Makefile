...
SRCS = main.c cli.c dump.c format.c color.c pattern.c elf.c stats.c reverse.c diff.c binfmt.c
OBJS = $(SRCS:.c=.o)

TEST_SRCS = tests/test_cli.c tests/test_pattern.c tests/test_elf.c tests/test_reverse.c \
            tests/test_format.c tests/test_diff.c tests/test_dump.c tests/test_binfmt.c
...
tests/test_diff: tests/test_diff.o diff.o format.o color.o pattern.o
	$(CC) $(CFLAGS) -o $@ $^ $(LDFLAGS)
tests/test_dump: tests/test_dump.o dump.o format.o color.o pattern.o elf.o binfmt.o
	$(CC) $(CFLAGS) -o $@ $^ $(LDFLAGS)
